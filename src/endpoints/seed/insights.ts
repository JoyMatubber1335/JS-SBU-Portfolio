export const insightsSeed = [
  {
    ...
    type: 'blog',
    summary:
      'Explore the latest techniques and best practices for optimizing web application performance in 2023.',
    slug: 'web-performance-optimization-techniques',
    tags: [{ tag: 'Performance' }, { tag: 'Web Development' }, { tag: 'Frontend' }],
  ...
  },
  {
    ...
    type: 'tutorial',
    summary:
      'Learn how to design, deploy and manage containerized applications using Kubernetes for scalable cloud solutions.',
    slug: 'kubernetes-cloud-native-tutorial',
    tags: [{ tag: 'Kubernetes' }, { tag: 'Cloud' }, { tag: 'DevOps' }],
    videoType: 'embed',
  ...
  },
  {
    ...
    type: 'tutorial',
    summary:
      'A beginner-friendly guide to implementing machine learning models using TensorFlow and JavaScript.',
    slug: 'machine-learning-tensorflow-intro',
    tags: [{ tag: 'Machine Learning' }, { tag: 'TensorFlow' }, { tag: 'JavaScript' }],
    videoType: 'embed',
  ...
  },
  {
    ...
    type: 'blog',
    summary:
      'Dive into microservices architecture patterns, communication strategies, and implementation considerations.',
    slug: 'microservices-architecture-patterns',
    tags: [{ tag: 'Architecture' }, { tag: 'Microservices' }, { tag: 'System Design' }],
