...
export const FeaturedPortfolio: React.FC<Props> = ({
  ...
  const {
    ...
    badgeBackgroundColor = 'rgba(0, 0, 0, 0.7)',
    accentColor = '#3b82f6',
  } = appearance || {}
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-wrap -mx-4">
          {projects.slice(0, 3).map((project, index) => (
            <div
              key={index}
              className={`px-4 mb-8 ${index === 0 ? 'w-full md:w-1/2' : 'w-full md:w-1/4'}`}
            >
              {index === 0 ? (
                ...
                <div className="relative h-[460px] rounded-lg overflow-hidden">
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                      <div className="mb-3">
                        <span
                          className="text-sm font-semibold text-white px-3 py-1 rounded-md"
