              ...
              <div className="flex space-x-4">
                {contact.socialLinks.facebook && (
                  <a href={contact.socialLinks.facebook} target="_blank" rel="noopener noreferrer" 
                    className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors">
        ...
        <div>
          {contact.contactFormSettings?.enableContactForm ? (
            ...
            <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <h2 className="text-xl font-semibold mb-3">Message Us</h2>
              <p>Our contact form is currently disabled. Please email us directly at {contact.email}.</p>
            </div>
          )}
        </div>
      </div>
