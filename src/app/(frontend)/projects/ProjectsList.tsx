      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {projects.map((project, index) => (
          <motion.div
            ...
            className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 relative"
          >
            {/* Clickable overlay that links to project detail page */}
            <Link 
            ...
            <div className="p-6">
              ...
              {/* Links - need higher z-index to be clickable */}
