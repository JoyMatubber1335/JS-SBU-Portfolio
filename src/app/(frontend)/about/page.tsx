      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {aboutData.team?.members?.map((member: any, index: any) => (
              <Link
                key={index}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {member.bio && <p className="text-black mb-6 line-clamp-3">{member.bio}</p>}
                  ...
                  {member.socialLinks && (
                    <div className="flex space-x-3">
                      ...
                      <SocialLink member={member} index={0} />
                      <SocialLink member={member} index={1} />
                      <SocialLink member={member} index={2} />
                      <SocialLink member={member} index={3} />
