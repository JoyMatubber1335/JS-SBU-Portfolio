...
const Footer: React.FC<FooterProps> = ({ footerData }) => {
  const address = footerData?.address || 'Mirpur DOSH -Dhaka Bangaladesh'
  const email = footerData?.email || 'joy.matubber.41959@gmail.com'
  const phone = footerData?.phone || '01408099845'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/services/ui-ux" className="text-gray-400 hover:text-white">
                  UI/UX Design
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/services/seo" className="text-gray-400 hover:text-white">
                  SEO Optimization
                </Link>
              </li>
            </ul>
